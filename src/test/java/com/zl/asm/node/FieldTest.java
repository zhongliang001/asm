...
class FieldTest {
    ...
    static byte[] filedBytes = new byte[]{0, 2, 0, 26, 0, 7, 0, 8, 0, 1, 0, 9, 0, 0, 0, 2, 0, 10, 0, 18, 0, 11, 0, 8, 0, 1, 0, 9, 0, 0, 0, 2, 0, 10};
    ...
    static ByteContainer nodeByteContainer;
    ...
    public static void init() {
        nodeByteContainer = new ByteContainer(bytes);
        node = new ConstantPoolNode(nodeByteContainer);
        byteContainer = new ByteContainer(filedBytes);
        field = new Field(byteContainer, node);
    }

    @Test
    public void test() {
        int fieldsCount = field.getFieldsCount();
        assertEquals(2, fieldsCount);
        FieldItem[] fieldItems = field.getFieldItems();
        assertEquals(2, fieldItems.length);
    }

    @Test
    public void getLog() {
        StringBuilder builder = new StringBuilder();
        field.getLog(builder);
