...
class FieldTest {
    ...
    byte[] filedBytes = new byte[]{0, 2, 0, 26, 0, 7, 0, 8, 0, 1, 0, 9, 0, 0, 0, 2, 0, 10, 0, 18, 0, 11, 0, 8, 0, 1, 0, 9, 0, 0, 0, 2, 0, 10};
    ...
    public void test() {
        ...
        ByteContainer byteContainer = new ByteContainer(filedBytes);
        Field field = new Field(byteContainer, node);
