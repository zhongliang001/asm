...
class CodeAttributeTest {
    ...
    static byte[] codeByte = new byte[]{0, 0, 0, 57, 0, 2, 0, 1, 0, 0, 0, 11, 42, -73, 0, 1, 42, 16, 10, -75, 0, 2, -79, 0, 0, 0, 2, 0, 15, 0, 0, 0, 10, 0, 2, 0, 0, 0, 3, 0, 4, 0, 6, 0, 16, 0, 0, 0, 12, 0, 1, 0, 0, 0, 11, 0, 17, 0, 18, 0, 0};
    static byte[] bytes = new byte[]{0, 31, 10, 0, 4, 0, 25, 9, 0, 3, 0, 26, 7, 0, 27, 7, 0, 28, 7, 0, 29, 7, 0, 30, 1, 0, 6,
    ...
    static byte[] codes = new byte[]{42, -73, 0, 1, 42, 16, 10, -75, 0, 2, -79};

    static ByteContainer nodeByteContainer = new ByteContainer(bytes);
    static ConstantPoolNode node = new ConstantPoolNode(nodeByteContainer);
    static ByteContainer codeByteContainer = new ByteContainer(codeByte);
    static CodeAttribute codeAttribute = new CodeAttribute(codeByteContainer, node, 1);
