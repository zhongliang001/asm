...
class ConstantAttributeTest {
    ...
    static byte[] bytes = new byte[]{0, 0, 0, 2, 0, 29};
    ...
    static ConstantAttribute constantAttribute;
    ...
    public static void init() {
        ...
        constantAttribute = new ConstantAttribute(byteContainer, poolNode, 28);
    }

    @Test
    public void test() {
        ByteContainer byteContainer = new ByteContainer(bytes);
        ConstantAttribute constantAttribute = new ConstantAttribute(byteContainer, null, 1);
        int constantvalueIndex = constantAttribute.getConstantvalueIndex();
        assertEquals(29, constantvalueIndex);
    }

    @Test
    public void getLog() {
        StringBuilder builder = new StringBuilder();
        constantAttribute.getLog(builder);
