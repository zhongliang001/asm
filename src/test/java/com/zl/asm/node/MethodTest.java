...
class MethodTest {
    ...
    byte[] methodBytes = new byte[]{0, 2, 0, 1, 0, 12, 0, 13, 0, 1, 0, 14, 0, 0, 0, 57, 0, 2, 0, 1, 0, 0, 0, 11, 42, -73, 0, 1, 42, 16, 10, -75, 0, 2, -79, 0, 0, 0, 2, 0, 15, 0, 0, 0, 10, 0, 2, 0, 0, 0, 3, 0, 4, 0, 6, 0, 16, 0, 0, 0, 12, 0, 1, 0, 0, 0, 11, 0, 17, 0, 18, 0, 0, 0, 1, 0, 19, 0, 13, 0, 1, 0, 14, 0, 0, 0, 93, 0, 2, 0, 4, 0, 0, 0, 9, 4, 60, 5, 61, 27, 28, 96, 62, -79, 0, 0, 0, 2, 0, 15, 0, 0, 0, 18, 0, 4, 0, 0, 0, 9, 0, 2, 0, 10, 0, 4, 0, 13, 0, 8, 0, 17, 0, 16, 0, 0, 0, 42, 0, 4, 0, 0, 0, 9, 0, 17, 0, 18, 0, 0, 0, 2, 0, 7, 0, 20, 0, 8, 0, 1, 0, 4, 0, 5, 0, 21, 0, 8, 0, 2, 0, 8, 0, 1, 0, 22, 0, 8, 0, 3};
    ...
    public void test(){
        ...
        ByteContainer methodByteContainer = new ByteContainer(methodBytes);
        Method method = new Method(methodByteContainer, node);
        int methodNum = method.getMethodNum();
        assertEquals(2, methodNum);
        MethodItem[] methodItem = method.getMethodItem();
        int length = methodItem.length;
